const styles = {
  ...
  // input: "p-2 h-7 shadow-md focus:ring-indigo-500 focus:border-indigo-500 block w-full sm:text-sm border-gray-300 rounded-md sm:mt-0 sm:ml-3 sm:w-auto sm:text-sm",
  input: "m-0 p-5 h-7 shadow-md focus:ring-indigo-500 focus:border-indigo-500 block w-full md:text-md border-gray-300 rounded-md md:mt-0 md:ml-3 md:w-auto md:text-md",
  reset: "m-3 bg-transparent hover:bg-red-500 text-gray-700 font-semibold hover:text-white py-2 px-4 border border-gray-500 hover:border-transparent rounded",
}
